...
\rowcolor{ltrow}data\_loader.py & Download UCI, cache CSV, split stratificato 60/20/20, tre varianti di preprocessing \\
...
\rowcolor{ltrow}report\_latex.py & Legge gli artefatti salvati e genera il report LaTeX/PDF \\
\bottomrule
\end{tabular}}}
\end{center}
...
\midrule
GreedyRuleList & max\_depth & 1, 2, 3, 4, 6 & 2 \\
\rowcolor{ltrow}GreedyRuleList & criterion & gini, entropy & gini \\
GreedyRuleList & class\_weight & None, balanced & None \\
...
SkopeRules & max\_depth & 2, 3, 4 & 2 \\
\rowcolor{ltrow}SkopeRules & precision\_min & 0.5, 0.6 & 0.6 \\
SkopeRules & recall\_min & 0.3, 0.4 & 0.3 \\
\rowcolor{ltrow}RandomForest & n\_estimators & 100, 200 & 100 \\
RandomForest & max\_depth & None, 5, 10 & None \\
\rowcolor{ltrow}RandomForest & min\_samples\_leaf & 1, 2, 5 & 5 \\
GradientBoosting & n\_estimators & 100, 200 & 100 \\
\rowcolor{ltrow}GradientBoosting & learning\_rate & 0.05, 0.1 & 0.1 \\
GradientBoosting & max\_depth & 3, 4, 5 & 3 \\
\rowcolor{ltrow}XGBoost & n\_estimators & 100, 200 & 100 \\
XGBoost & learning\_rate & 0.05, 0.1 & 0.05 \\
\rowcolor{ltrow}XGBoost & max\_depth & 3, 4, 5 & 4 \\
\bottomrule
\end{tabular}}}
\end{center}
\end{minipage}
...
\rowcolor{ltrow}TEST\_SIZE & 0.20 & 20\% test ($\approx$60 campioni), mantenuto separato durante il tuning \\
VAL\_SIZE & 0.20 & 20\% validation ($\approx$60 campioni) per la scelta degli iperparametri \\
\rowcolor{ltrow}CV\_FOLDS & 10 & 10-fold CV su trainval ($\approx$240 campioni): stima robusta della stabilita' \\
BRL\_MAX\_ITER & 20\,000 & Iterazioni MCMC per la convergenza (ridotto a 3\,000 durante il tuning) \\
\rowcolor{ltrow}RULEFIT\_MAX\_RULES & 30 & Limita le regole candidate; troppe degenerano in black-box \\
...
\toprule
\cellcolor{tblhdr}\color{white}\bfseries Condizione & \cellcolor{tblhdr}\color{white}\bfseries P(decesso) & \cellcolor{tblhdr}\color{white}\bfseries IC 95\% \\
\midrule
...
\rowcolor{ltrow}RF\_no\_time & 0.7500 & 0.5161 & 0.7754 \\
GreedyRuleList & 0.8333 & 0.6667 & 0.8331 \\
\rowcolor{ltrow}GRL\_no\_time & 0.6833 & 0.5366 & 0.7003 \\
BayesianRuleList & 0.7500 & 0.6809 & 0.8408 \\
\rowcolor{ltrow}BRL\_no\_time & 0.3167 & 0.4810 & 0.6528 \\
\bottomrule
\end{tabular}}}
\end{center}
